#ifndef H_AODV_WAIT_TIMER
#define H_AODV_WAIT_TIMER
...
public:
    ...
    /**
     * @brief Sets the wait time duration.
     * 
     * @param waitTime Time duration (in seconds) to wait.
     */
    void setTime(double waitTime)
    {
        interrupt(); // Stops the timer if it is already started.
